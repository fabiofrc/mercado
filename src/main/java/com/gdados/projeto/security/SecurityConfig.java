...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.userDetailsService(userDetailsService())
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/Home.xhtml", "/login.xhtml", "/paginas/plb/**", "/erro.xhtml", "/javax.faces.resources/**").permitAll()
                .antMatchers("/paginas/adm/**").hasRole("ADMINISTRADOR")
                .antMatchers("/paginas/pf/pessoa_fisica/*").hasRole("PARTICIPANTE")
                .antMatchers("/paginas/pf/pessoa_juridica/*").hasRole("PESSOAJURIDICA")
