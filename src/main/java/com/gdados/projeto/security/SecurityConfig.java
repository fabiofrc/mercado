...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.userDetailsService(userDetailsService())
                ...
                .antMatchers("/paginas/pf/**", "/paginas/pf/pessoa_fisica/cadastro_perfil", "/login.xhtml").hasRole("PARTICIPANTE")
                .antMatchers("/paginas/pf/**", "/paginas/pf/pessoa_juridica/cadastro_perfil", "/login.xhtml").hasRole("PESSOAJURIDICA")
