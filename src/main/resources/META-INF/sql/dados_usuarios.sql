...
insert into endereco(id, logradouro) values (1, 'meu endereço');
insert into pessoa(id, nome, dtype, usuario_id, endereco_id) values (1, 'administrador do sistema', 'PessoaFisica', 1, 1);
insert into pessoafisica(cpf, pessoafisica_id) values ('000.000.000-80', 1);
